...
SCHEMA_PATH = Path('/home/l1/Uni/kofiEschloss/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/l1/.cache/prisma-python/binaries/5.4.2/ac9d7041ed77bcc8a8dbd2ab6616b39013829574/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    ...
    card: 'actions.CardActions[models.Card]'
    ...
    def __init__(
        ...
        *,
        ...
        self.card = actions.CardActions[models.Card](self, models.Card)
    ...
    def _default_datasource(self) -> DatasourceOverride:
        return {
            'name': 'db',
            'url': OptionalValueFromEnvVar(**{'value': 'file:../test.db', 'fromEnvVar': None}).resolve(),
        }
...
class Batch:
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.card = CardBatchActions(self)
